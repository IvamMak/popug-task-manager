...
public class TaskAssignedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -690461536906845467L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TaskAssignedEvent\",\"namespace\":\"com.example.schemaregistry.task.assigned\",\"fields\":[{\"name\":\"eventName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"eventPayload\",\"type\":{\"type\":\"record\",\"name\":\"TaskAssignedPayload\",\"fields\":[{\"name\":\"publicId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"assignerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"executorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}}],\"version\":\"1\"}");
  ...
  @Deprecated public com.example.schemaregistry.task.assigned.TaskAssignedPayload eventPayload;
   ...
   */
  public TaskAssignedEvent(java.lang.String eventName, com.example.schemaregistry.task.assigned.TaskAssignedPayload eventPayload) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: eventPayload = (com.example.schemaregistry.task.assigned.TaskAssignedPayload)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.example.schemaregistry.task.assigned.TaskAssignedPayload getEventPayload() {
    return eventPayload;
  }
   ...
   * @param value the value to set.
   */
  public void setEventPayload(com.example.schemaregistry.task.assigned.TaskAssignedPayload value) {
   ...
   */
  public static com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder newBuilder() {
    return new com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder();
  }
   ...
   * @return A new TaskAssignedEvent RecordBuilder
   */
  public static com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder newBuilder(com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder other) {
    if (other == null) {
      return new com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder();
    } else {
      return new com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder(other);
    }
  }
   ...
   * @return A new TaskAssignedEvent RecordBuilder
   */
  public static com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder newBuilder(com.example.schemaregistry.task.assigned.TaskAssignedEvent other) {
    if (other == null) {
      return new com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder();
    } else {
      return new com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TaskAssignedEvent>
    ...
    private com.example.schemaregistry.task.assigned.TaskAssignedPayload eventPayload;
    private com.example.schemaregistry.task.assigned.TaskAssignedPayload.Builder eventPayloadBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder other) {
      super(other);
      ...
      if (other.hasEventPayloadBuilder()) {
        this.eventPayloadBuilder = com.example.schemaregistry.task.assigned.TaskAssignedPayload.newBuilder(other.getEventPayloadBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.schemaregistry.task.assigned.TaskAssignedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventName)) {
        this.eventName = data().deepCopy(fields()[0].schema(), other.eventName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder setEventName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder clearEventName() {
      eventName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder setEventPayload(com.example.schemaregistry.task.assigned.TaskAssignedPayload value) {
     ...
     * @return This builder.
     */
    public com.example.schemaregistry.task.assigned.TaskAssignedPayload.Builder getEventPayloadBuilder() {
      if (eventPayloadBuilder == null) {
        if (hasEventPayload()) {
          setEventPayloadBuilder(com.example.schemaregistry.task.assigned.TaskAssignedPayload.newBuilder(eventPayload));
        } else {
          setEventPayloadBuilder(com.example.schemaregistry.task.assigned.TaskAssignedPayload.newBuilder());
        }
      }
    ...
    public com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder setEventPayloadBuilder(com.example.schemaregistry.task.assigned.TaskAssignedPayload.Builder value) {
      clearEventPayload();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schemaregistry.task.assigned.TaskAssignedEvent.Builder clearEventPayload() {
      eventPayload = null;
    ...
    public TaskAssignedEvent build() {
      try {
        ...
        if (eventPayloadBuilder != null) {
          ...
          record.eventPayload = fieldSetFlags()[1] ? this.eventPayload : (com.example.schemaregistry.task.assigned.TaskAssignedPayload) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.eventPayload == null) {
        this.eventPayload = new com.example.schemaregistry.task.assigned.TaskAssignedPayload();
      }
