...
public class TaskCompletedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3483498193939655737L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TaskCompletedEvent\",\"namespace\":\"com.example.schemaregistry.task.completed\",\"fields\":[{\"name\":\"eventName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"eventPayload\",\"type\":{\"type\":\"record\",\"name\":\"TaskCompletedPayload\",\"fields\":[{\"name\":\"publicId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"executorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}}],\"version\":\"1\"}");
  ...
  @Deprecated public com.example.schemaregistry.task.completed.TaskCompletedPayload eventPayload;
   ...
   */
  public TaskCompletedEvent(java.lang.String eventName, com.example.schemaregistry.task.completed.TaskCompletedPayload eventPayload) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: eventPayload = (com.example.schemaregistry.task.completed.TaskCompletedPayload)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.example.schemaregistry.task.completed.TaskCompletedPayload getEventPayload() {
    return eventPayload;
  }
   ...
   * @param value the value to set.
   */
  public void setEventPayload(com.example.schemaregistry.task.completed.TaskCompletedPayload value) {
   ...
   */
  public static com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder newBuilder() {
    return new com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder();
  }
   ...
   * @return A new TaskCompletedEvent RecordBuilder
   */
  public static com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder newBuilder(com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder other) {
    if (other == null) {
      return new com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder();
    } else {
      return new com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder(other);
    }
  }
   ...
   * @return A new TaskCompletedEvent RecordBuilder
   */
  public static com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder newBuilder(com.example.schemaregistry.task.completed.TaskCompletedEvent other) {
    if (other == null) {
      return new com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder();
    } else {
      return new com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TaskCompletedEvent>
    ...
    private com.example.schemaregistry.task.completed.TaskCompletedPayload eventPayload;
    private com.example.schemaregistry.task.completed.TaskCompletedPayload.Builder eventPayloadBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder other) {
      super(other);
      ...
      if (other.hasEventPayloadBuilder()) {
        this.eventPayloadBuilder = com.example.schemaregistry.task.completed.TaskCompletedPayload.newBuilder(other.getEventPayloadBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.schemaregistry.task.completed.TaskCompletedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventName)) {
        this.eventName = data().deepCopy(fields()[0].schema(), other.eventName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder setEventName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder clearEventName() {
      eventName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder setEventPayload(com.example.schemaregistry.task.completed.TaskCompletedPayload value) {
     ...
     * @return This builder.
     */
    public com.example.schemaregistry.task.completed.TaskCompletedPayload.Builder getEventPayloadBuilder() {
      if (eventPayloadBuilder == null) {
        if (hasEventPayload()) {
          setEventPayloadBuilder(com.example.schemaregistry.task.completed.TaskCompletedPayload.newBuilder(eventPayload));
        } else {
          setEventPayloadBuilder(com.example.schemaregistry.task.completed.TaskCompletedPayload.newBuilder());
        }
      }
    ...
    public com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder setEventPayloadBuilder(com.example.schemaregistry.task.completed.TaskCompletedPayload.Builder value) {
      clearEventPayload();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.schemaregistry.task.completed.TaskCompletedEvent.Builder clearEventPayload() {
      eventPayload = null;
    ...
    public TaskCompletedEvent build() {
      try {
        ...
        if (eventPayloadBuilder != null) {
          ...
          record.eventPayload = fieldSetFlags()[1] ? this.eventPayload : (com.example.schemaregistry.task.completed.TaskCompletedPayload) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.eventPayload == null) {
        this.eventPayload = new com.example.schemaregistry.task.completed.TaskCompletedPayload();
      }
